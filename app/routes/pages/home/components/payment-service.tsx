      ...
      <div className="container flex pt-[250px]">
        <div className="flex-1">
          <InDropUp>
            ...
            <p className="pt-[60px] text-[23px] leading-[1.5] font-[600] text-[#4e5968]">
              온라인과 오프라인 모두
              <br />
              국내는 물론, 해외에서도
              <br />
        ...
        <div className="flex-1">
          <InDropUp>
            <div className="relative">
              <img
                className="absolute top-[87px] left-[81px] w-[300px]"
          ...
          <InDropUp>
            <p className="ml-[60px] pt-[60px] text-[23px] leading-[1.5] font-[600] text-[#4e5968]">
              결제할 땐, 혜택이 빠질 수 없죠.
              <br />
              쿠폰과 포인트 써서 할인 받고
              <br />
